...
% regulation?
% but even logistic regression is often "explained"
...
% but even logistic regression is often "explained"
	...
	\begin{frame}
		...
		\centering{\includegraphics[scale=0.08]{img/blueprint.png}}\\
		\vspace{5pt}
		\scriptsize{A diagram of a proposed low risk ML workflow in which explanations (highlighted in \textcolor{magenta}{fuschia}) are used along with interpretable or white-box models, disparate impact analysis and remediation techniques, and other review and appeal mechanisms to create a fair, accountable, and transparent ML system.}
...
%Acknowledgements: Sameer, Pramit, Cristoph, Premyslaw, MLI team, Sri, Leland 		
