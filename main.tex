...
\footnotesize{Many ML hacks use, or are exacerbated by, explainable ML techniques.}\footnote{\tiny{See \url{https://github.com/jphall663/secure_ML_ideas} for full size image and more information.}}
	...
	\begin{frame}
		...
		\end{itemize}
		... \textbf{might} be viewed as white-hat attacks on proprietary black-boxes (respectively, model stealing and adversarial examples).
...
%-------------------------------------------------------------------------------
	...
	\begin{frame}
		...
		\large
		Models of models (i.e. surrogate models, compressed models, extracted models) can be helpful explanatory or modeling tools, but they are also usually approximate, low-fidelity explainers.\\
		\vspace{10pt}
...
% XNN
		...
		Many types of accurate and interpretable models are available today, e.g. ...
		...
		... use them for human-centered or other high stakes ML applications.
